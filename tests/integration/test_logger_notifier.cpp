...
TEST(IntegrationTest, LoggerNotifier_MockCalculator) {
    // Create instances of the mock Calculator, Logger, and Notifier with a threshold of 5.
    ...
    // Since the result is below the threshold (4 < 5), the Notifier should not trigger.
