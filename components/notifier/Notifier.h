...
/**
 * @brief Monitors results and triggers a notification when a threshold is exceeded.
 */
class Notifier {
public:
    /**
    ...
    /**
     * @brief Checks the given result and triggers a notification if it exceeds the threshold.
